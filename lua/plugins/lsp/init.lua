...
vim.lsp.config("lua_ls", {
	...
	-- Evita que se levanten múltiples instancias idénticas si cambias de buffer rápido
	single_file_support = true,
	settings = {
		Lua = {
			runtime = {
				version = "LuaJIT",
				-- Evita buscar paths ambiguos o librerías del sistema de forma global
				pathStrict = true,
			},
			diagnostics = {
				globals = { "vim" },
			...
			workspace = {
				...
				-- Límites drásticos para frenar el proceso si se descontrola
				maxPreload = 100,
...
-- ============================================================================
-- DETECCIÓN AUTOMÁTICA DE LSP AL RENOMBRAR / GUARDAR
-- ============================================================================
